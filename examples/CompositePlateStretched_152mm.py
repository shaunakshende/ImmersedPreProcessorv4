...
<<<<<<< HEAD:examples/CompositePlateStretched_152mm.py
...
#print(S.knots)
=======
S = sf.background_with_uniform_refinement(C3, C4, 0.305+1.0*padding, np.array([81, 81, 81]),O, np.array([0.4, 0.6]), np.array([0.4, 0.6]), np.array([0.0, 0.2]), 11);

S = sf.linear_stretch_bg_one_sided(S, 0.4, 1.57, 0, C3, C4, 0.305+1.0*padding, -1);
S = sf.linear_stretch_bg_one_sided(S, 0.6, 1.57, 0, C3, C4, 0.305+1.0*padding, 1);
#
S = sf.linear_stretch_bg_one_sided(S, 0.4, 1.57, 1, C3, C4, 0.305+1.0*padding, -1);
S = sf.linear_stretch_bg_one_sided(S, 0.6, 1.57, 1, C3, C4, 0.305+1.0*padding, 1);

#S = sf.linear_stretch_bg_one_sided(S, 0.4, 1.57, 0, C3, C4, 0.305+1.0*padding, -1);

S = sf.linear_stretch_bg_one_sided(S, 0.2, 1.45, 2, C3, C4, 0.305+1.0*padding, 1);
>>>>>>> b939304c0a120585301d5074d26994e02fab1929:CompositePlateStretched.py
