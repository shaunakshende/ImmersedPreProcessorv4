...
S = sf.background_with_uniform_refinement(C0, C1, 2.0, np.array([51, 51, 51]),O, np.array([0.0, 1.6])/2.0, np.array([0.0, 1.6])/2.0, np.array([0.0, 1.6])/2.0, 2);
...
S = sf.unif_linear_unif_BG_1D(S, 1.6/2.0, 0.05, 0, C0, C1, 2.0, (2.0/100.0)/2.0, 0.04/2.0, -1);
S = sf.unif_linear_unif_BG_1D(S, 1.6/2.0, 0.05, 1, C0, C1, 2.0, (2.0/100.0)/2.0, 0.04/2.0, -1);
S = sf.unif_linear_unif_BG_1D(S, 1.6/2.0, 0.05, 2, C0, C1, 2.0, (2.0/100.0)/2.0, 0.04/2.0, -1);
